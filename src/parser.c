...
enum {
  ...
  sym__entity_name = 28,
  sym__field_name = 29,
  sym__haskell_constraint_name = 30,
  sym__entity_header = 31,
  sym__entity_line_definition = 32,
  sym__entity_key = 33,
  sym__surrogate_key = 34,
  sym__natural_key = 35,
  sym__key_attribute = 36,
  sym__entity_attribute = 37,
  sym__field_attribute = 38,
  sym_field_definition = 39,
  sym__field_type = 40,
  sym_type = 41,
  aux_sym__cascade_actions = 42,
  sym__unique_constraint = 43,
  sym__unique_constraint_attribute = 44,
  sym__constraint_name = 45,
  sym__foreign_constraint = 46,
  sym__class_name = 47,
  sym_entity_derives = 48,
  aux_sym_quasi_quotation_repeat1 = 49,
  aux_sym_entity_body_repeat1 = 50,
  aux_sym_entity_body_repeat2 = 51,
  aux_sym__entity_header_repeat1 = 52,
  aux_sym__surrogate_key_repeat1 = 53,
  aux_sym__natural_key_repeat1 = 54,
  aux_sym_field_definition_repeat1 = 55,
  aux_sym__unique_constraint_repeat1 = 56,
  aux_sym_entity_derives_repeat1 = 57,
  alias_sym_identifier = 58,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_entity_definition] = STATE(62),
    [sym_comment] = STATE(1),
    [sym__entity_name] = STATE(30),
    [sym__entity_header] = STATE(28),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(71),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(89),
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(26),
  [38] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(27),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(60),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 2), SHIFT_REPEAT(68),
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__natural_key, 2),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__entity_line_definition, 2),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_line_definition, 2),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__unique_constraint, 2),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_entity_body_repeat1, 1),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_body_repeat1, 1),
  [69] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__natural_key_repeat1, 2), SHIFT_REPEAT(25),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__natural_key_repeat1, 2),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quasi_quotation, 1),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_quasi_quotation_repeat1, 2),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_quasi_quotation_repeat1, 2), SHIFT_REPEAT(77),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_quasi_quotation_repeat1, 2), SHIFT_REPEAT(79),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [86] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__foreign_constraint, 5),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__foreign_constraint, 4),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__foreign_constraint, 7),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__foreign_constraint, 6),
  [98] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entity_derives_repeat1, 2), SHIFT_REPEAT(58),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_derives_repeat1, 2),
  [103] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_derives, 2),
  [107] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [109] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_header, 3, .production_id = 4),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_header, 3, .production_id = 3),
  [117] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__entity_header_repeat1, 2), SHIFT_REPEAT(74),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__entity_header_repeat1, 2),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__field_name, 1),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__field_name, 1),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variable, 1),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(80),
  [132] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_definition, 1, .production_id = 2),
  [136] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [138] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [140] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__unique_constraint_repeat1, 2), SHIFT_REPEAT(72),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__unique_constraint_repeat1, 2),
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_field_definition_repeat1, 2), SHIFT_REPEAT(69),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_definition_repeat1, 2),
  ...
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_header, 4, .production_id = 4),
  [160] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_definition, 3, .production_id = 4),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__surrogate_key, 2),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_definition, 4, .production_id = 4),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__natural_key_repeat1, 1),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__natural_key_repeat1, 1),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__surrogate_key_repeat1, 2), SHIFT_REPEAT(66),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__surrogate_key_repeat1, 2),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_definition, 2, .production_id = 3),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__unique_constraint, 3),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_definition, 3, .production_id = 3),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_header, 2, .production_id = 3),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_body, 2),
  [187] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entity_body_repeat2, 2), SHIFT_REPEAT(56),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_body_repeat2, 2),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__surrogate_key, 3),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__natural_key, 3),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_derives_repeat1, 1),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__class_name, 1, .production_id = 5),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entity_definition, 4, .production_id = 2),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__cascade_actions, 2),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__cascade_actions, 2), SHIFT_REPEAT(65),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_quasi_quotation_repeat1, 1),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entity_body_repeat2, 1),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__entity_header_repeat1, 1),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__cascade_actions, 1),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__key_attribute, 1),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__surrogate_key_repeat1, 1),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__field_attribute, 1),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_field_definition_repeat1, 1),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__unique_constraint_attribute, 1),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__unique_constraint_repeat1, 1),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_attribute, 1),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 3),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_name, 1, .production_id = 1),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__field_type, 1),
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__entity_key, 1),
  [247] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [249] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__constraint_name, 1),
  [253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__haskell_constraint_name, 1, .production_id = 1),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1),
};
